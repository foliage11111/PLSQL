...
REM | 23-DEC-2014 ALAYTON Renamed and changed to single mode.                 |
REM +=========================================================================+
...
REM 
REM MENU_TITLE: Approval Analyzer Diagnostic Script (Single) 
REM
REM MENU_START
REM SQL: Run PO Approval Analyzer in "single" Mode 
...
REM
REM    (1) Runs PO Approval Analyzer as APPS in "single" mode
REM      
...
REM        o Default Request Group: "All Reports" (PO Product) 
REM 
REM HELP_END 
REM 
REM FNDLOAD_START 
...
PROMPT 'PO', 'PA', 'REQUISITION', or 'RELEASE'.
PROMPT ===========================================================================
PROMPT
ACCEPT trx_type CHAR PROMPT 'Enter the document type: '
PROMPT
PROMPT ===========================================================================
PROMPT Enter the PO or requisition number.
PROMPT ===========================================================================
PROMPT
...
BEGIN
  ...
  po_apprvl_analyzer_pkg.main_single(
      p_org_id => l_org_id,
